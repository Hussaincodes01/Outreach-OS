...
async def test_add_item_chunks_and_stores_embeddings(_fake_llm):
...
async def test_search_returns_relevant_chunks(_fake_llm):
    factory = get_session_factory()
...
async def test_search_isolated_per_tenant(_fake_llm):
    factory = get_session_factory()
...
async def test_delete_item_cascades_to_chunks(_fake_llm):
    factory = get_session_factory()
